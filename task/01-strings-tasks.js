...
function getCardId(value) {
    ...
    var result = +getKeyByValue(rank, value.substring(0, value.length - 1)) + 13 * (+getKeyByValue(suits, value.substring(value.length, value.length-1)));
    return result;
}
